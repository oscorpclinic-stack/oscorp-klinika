    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="fixed bottom-6 left-6 right-6 md:left-auto md:right-10 md:bottom-10 md:w-auto z-[60]">
        <button 
          ...
          className="bg-emerald-950 text-white shadow-2xl rounded-full px-6 py-4 flex items-center justify-center gap-3 w-full md:w-auto hover:scale-105 active:scale-95 transition-all group border border-white/20"
        >
